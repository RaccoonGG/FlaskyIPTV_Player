...
| `radio_lan.html` | optional | Standalone LAN radio browser/player served by `radio_addon.py` at `/radio` — plays independently on whatever device opens it; also works copied onto a phone and opened as a standalone file |
...
- Full station browser — **Favourites, Top, Built-in, Trending, Genres, Countries, Languages, Nearby, History, Search** — the same tabs and data as the on-screen radio panel
...
- The radio Now Playing bar's track title comes from whatever ICY metadata the station itself sends; some stations report nothing, and a few report it minutes late or not at all — this isn't something FlaskyIPTV controls
